...
Внимание
Обрати внимание на то, что в коде нет вызовов функции makeMessage. С этого задания 
и дальше мы сами будем вызывать твои функции и проверять то, как они работают. 
...
function makeMessage (name, price) {
 ...
 // makeMessage('Радар', 6150);  <---- для проверки функции при отсутствии return message;

//2-й вариант на проверку вызова функции
