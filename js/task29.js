...
getShippingCost('Китай');// возвращает 'Доставка в Китай будет стоить 100 кредитов'.
getShippingCost('Чили');// возвращает 'Доставка в Чили будет стоить 250 кредитов'.
getShippingCost('Ямайка');// возвращает 'Доставка в Ямайка будет стоить 120 кредитов'.
getShippingCost('Швеция');// возвращает 'Извините, в вашу страну доставки нет'.
