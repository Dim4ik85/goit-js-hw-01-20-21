...
function checkPassword(password) {
    ...
    message = password === ADMIN_PASSWORD ? 'Доступ разрешен'
    : 'Доступ запрещён, неверный пароль!';
    console.log(message);
    // Пиши код выше этой строки
    //return message;
  }
  checkPassword('jqueryismyjam');// возвращает 'Доступ разрешен'
  checkPassword('angul4r1sl1f3');// возвращает 'Доступ запрещён, неверный пароль!'