...
checkPassword('mangohackzor');// возвращает 'Доступ запрещен, неверный пароль!'
checkPassword(null);// возвращает 'Отменено пользователем!'.
checkPassword('polyhax');// возвращает 'Доступ запрещен, неверный пароль!'.
checkPassword('jqueryismyjam');// возвращает 'Добро пожаловать!'.