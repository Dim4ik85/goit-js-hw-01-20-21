...
function getNameLength(name) {
  ...
  getNameLength('Poly');// возвращает 'Длина вашего имени 4 символа(ов)'.
getNameLength('Harambe');// возвращает 'Длина вашего имени 6 символа(ов)'.
getNameLength('Billy');// возвращает 'Длина вашего имени 5 символа(ов)'.
getNameLength('Joe');// возвращает 'Длина вашего имени 3 символа(ов)'.
