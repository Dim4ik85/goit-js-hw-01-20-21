...
В противном случае записывается строка 'Заказ оформлен, с вами свяжется
 менеджер'.
...
//   checkStorage(200, 150);// возвращает 'Заказ оформлен, с вами свяжется менеджер'.
//   checkStorage(150, 180);// возвращает 'На складе недостаточно товаров!'.
